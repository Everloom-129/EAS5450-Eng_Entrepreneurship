...
> 在真正理解客户之前就扩张销售，不是在加速增长——而是在加速错误的假设。等你察觉到的时候，跑道可能已经所剩无几。
...
销售学习曲线背后有一个更宏观的原则：在验证核心假设之前，不要大规模扩张。在初创公司，过早扩张会断掉跑道。导致这一错误的本能是可以理解的，但莱斯利和霍洛威说得很清楚：启动阶段不是关于增长，而是关于理解。先学习，后扩展。

Clever案例（来自YC视频）是最清晰的佐证：CEO泰勒·博斯门尼在招聘任何人之前，花了数月时间亲自做销售。这不是低效，而是建立可复制销售模式的最快路径。他对早期销售对话的法则：通话时间70%用于倾听，30%用于表达。目标是比客户自己更清楚地理解他们的问题——而你无法边推销边做到这一点。

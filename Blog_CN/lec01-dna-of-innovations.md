...
如果现在对自己的发现技能打分：**关联（4/5）、发问（4/5）、观察（2/5）、实验（3/5）、社交（5/5）**。最薄弱的是观察——我倾向于在充分理解问题之前便急于动手，本质上是确认偏差在作怪：在你预期的世界里验证假设，而非实际存在的世界。

阿加西斯原则提醒我们：多盯着那条鱼看一会儿。你所学到的大部分，不来自证实你已有的想法，而来自发现那些不合预期的地方。

HP是德鲁克框架最有力的证明：市场优先、量入为出的财务、以信任为基础的文化，以及两位对愿景全力投入的创始人。这不是运气，而是纪律。

HP的三项实践值得特别点出。**邻桌法则**：为坐在你旁边的工程师构建产品，因为你们共享同样的问题——这是用户中心设计最早的工业实践，从机制上倒逼产品与市场的契合。**无跟风产品**原则：每次发布必须带来真正的进步；照搬竞争对手的产品是文化上的违规，而不仅仅是战略上的失误。以及**走动式管理（MBWA）**：帕卡德与休利特走进车间，直接与工程师交谈，将这种直接接触作为产品与团队士气问题的预警系统，让问题在恶化之前得到发现。每一位亲身到场、而非只看报告的管理者，都在做同样的事。

...
- 付费广告将推动获客 -- **已否定**，存储关键词的CPC过高且转化率过低。霍斯顿自己的总结一针见血："搜索擅长收割已有需求，而非创造需求。" Dropbox需要的是从零创造需求，这需要完全不同的渠道。
...
Dropbox的故事是一个很好的提醒：最有成效的路径通常不是最快的。霍斯顿18个月的"延误"，是18个月的结构化学习——每个功能都经过真实用户行为的检验，每个定价假设都得到验证或推翻。最终产品之所以更好，正是因为花了更长时间。

认知偏差框架同样有力。乐观偏差和规划谬误存在于几乎所有复杂项目中。解决之道不是悲观，而是更好的实验设计：将假设分解为更小的可证伪部分，优先测试最难的假设。Dropbox始终如此，这就是为何推荐计划替代了付费广告——而非叠加在其上。

...
The Palm story is one of the cleanest demonstrations of product-market fit I've seen. Hawkins literally walked around with a wooden block carved to the size he wanted the PalmPilot to be, before any hardware was built. He used it to simulate the workflow — pulling it out of his pocket to "check" a contact. Physical prototyping to validate the user experience before spending on engineering. That's the Agassiz principle applied to product design: observe first, build second.

The deeper principle here is that constraints clarify. When Hawkins fixed two hard requirements — fit in a shirt pocket, last a full charge — every other decision followed from those. Features that didn't fit those constraints got cut, not deferred. That discipline is what separated Palm from every competitor that kept adding "one more thing."

...
The broader lesson extends beyond pharma: any startup operating in a regulated domain — autonomous vehicles, medical robotics, aviation, financial services — needs to treat regulatory strategy as core product work, not legal overhead. Understanding regulatory strategy before you need it is the engineering entrepreneurship move. The founders who've already mapped the approval path are ready to move when the technology is.
